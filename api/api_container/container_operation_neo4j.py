...
from resources.swagger_modules import (dataset_sample_return,
...
# init logger
_logger = LoggerFactory('api_dataset_ops').get_logger()
...
class Container(Resource):
    ...
    def put(self, project_geid):
        ...
        try:
            ...
            datasets = check_container_exist("Container", dataset_id)
            if len(datasets) == 0:
